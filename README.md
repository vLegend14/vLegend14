...
Linux · Windows · system-level concepts · shell scripting

**Backend & Logic**  
Services · APIs · automation · backend-oriented development

**Embedded Systems (Basic)**  
Basic embedded development · hardware interaction · experimentation
...
**Cybersecurity & automation tools — ongoing**  
Scripts and tools for analysis, automation, and security workflows.
